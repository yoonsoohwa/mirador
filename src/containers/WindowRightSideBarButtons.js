...
const mapStateToProps = (state, { windowId }) => ({
  ...
  rightSideBarPanel: (getCompanionWindowsForPosition(state, { position: 'left', windowId })[0] || {}).content,
});

const enhance = compose(connect(mapStateToProps, mapDispatchToProps), withPlugins('WindowRightSideBarButtons'));
